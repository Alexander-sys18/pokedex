...
export function SurpriseButton() {
  ...
  return (
    <button
      ...
      disabled={isPending}
      aria-busy={isPending}
      className="border-border bg-surface/80 text-foreground hover:bg-surface-hover focus-visible:ring-ring inline-flex h-10 items-center gap-2 rounded-xl border px-4 text-sm font-medium transition-colors focus-visible:ring-2 focus-visible:outline-none disabled:opacity-70"
    >
